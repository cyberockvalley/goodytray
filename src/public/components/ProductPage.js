...
import { commaNum, truncText, cls, getParam } from "../utils/Funcs"
...
class ProductPage extends Component {
    ...
    componentDidMount() {
        ...
        const id = getParam(this, 'id')//parseInt(paths[paths.length - 1])
        const preview = getParam(this, 'preview')
        console.log("getParam", "productId_&_preview", id, preview)

        browser.axios.get(API_ROOT + `products/details?vi=1&id=${id}&force_show=${preview}`)
        .then(response => {
            ...
            <Navbar user={this.props.user} />
              {
                  ...
                  <div className="h-bg-grey h-pb-15">
                      <div className="b-bouncing-loader-wrapper" data-v-67bc6bc4="">
                  ...
                  <div className="h-bg-grey h-pb-15">
                    ...
                    <div className="b-bouncing-loader-wrapper" data-v-67bc6bc4="" style={{display: "none"}}>
                    <div className="b-bouncing-loader spinner-absolute h-pt-20" style={{bottom: "0px"}}>
                        <div>
                        </div>
                        <div>
                    ...
                    <ul className="qa-bread-crumbs b-breadcrumb-wrapper h-no-text-overflow h-pb-10" data-v-67bc6bc4="">
                        ...
                        <li className="b-breadcrumb-inner">
                        <Link className="qa-bread-crumbs-link b-breadcrumb-link" to={this.state.product?catLink(this.state.product.cat_name, this.state.product.cat_id):""}>
                        <span>
                        ...
                        <li className="b-breadcrumb-inner">
                        <Link className="qa-bread-crumbs-link b-breadcrumb-link" to={this.state.product?subCatLink(this.state.product.sub_cat_name, this.state.product.sub_cat_id):""}>
                        <span>
